...
CREATORHUB.tools = [
  ...
  { id: 'calchub', name: 'Calchub', desc: 'Financial, health, math, and unit conversion calculators. One hub for all calculations.', url: 'https://covercraft-ai-jade.vercel.app/', icon: '🧮', color: 'green', screenshots: 1, warning: 'URL needs its own deployment (currently shares CovercraftAI URL)' },
